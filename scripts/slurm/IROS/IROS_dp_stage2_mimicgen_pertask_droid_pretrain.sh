...
mkdir -p "$LOG_DIR"
exec > "${LOG_DIR}/train_dah_stage2_droid_pretrain_array_${1}_${SLURM_ARRAY_TASK_ID}_${SLURM_ARRAY_JOB_ID}${_NOTE:+_${_NOTE}}.log" 2>&1
...
scontrol update JobId="$SLURM_JOB_ID" JobName="dah_s2_dp_${ARCH}"
...
echo "=============================================="
echo "SLURM Array Job: DAH Stage 2 (${ARCH}) — DROID Pretrained"
echo "=============================================="
...
EXP_NAME="DAH_stage2_${ARCH}_droid_pretrain_seed${SEED}"
