...
#
# Usage:
#   sbatch scripts/slurm/RSS/RSS_droid_dp_stage1_droid_data.sh <arch> <seed> [NOTE] [EXTRA_ARGS...]
#   sbatch scripts/slurm/RSS/RSS_droid_dp_stage1_droid_data.sh dp_c 42
#   sbatch scripts/slurm/RSS/RSS_droid_dp_stage1_droid_data.sh dp_t 42 first_run
# =============================================================================
