...
#
# Same as RSS_droid_dp_stage2_libero_persuite.sh, but uses a Stage 1
# checkpoint pretrained on DROID data (from RSS_droid_dp_stage1_droid_data.sh).
#
...
#
# Usage:
#   sbatch scripts/slurm/RSS/RSS_droid_dp_stage2_libero_persuite_droid_pretrain.sh <arch> <suite> <seed> <stage1_ckpt> [NOTE] [EXTRA_ARGS...]
#
# Arch options: dp_c, dp_t, dp_mlp, dp_t_film
# Suite options: libero_spatial, libero_object, libero_goal, libero_10
#
# Example:
#   sbatch scripts/slurm/RSS/RSS_droid_dp_stage2_libero_persuite_droid_pretrain.sh dp_c libero_spatial 42 /path/to/stage1.ckpt
#
# To launch all suites for one arch:
#   for s in libero_spatial libero_object libero_goal libero_10; do
#     sbatch scripts/slurm/RSS/RSS_droid_dp_stage2_libero_persuite_droid_pretrain.sh dp_c $s 42 $CKPT
#   done
# =============================================================================
