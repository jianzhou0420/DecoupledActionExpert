#!/bin/bash
#
# DEBUG: DAH Stage 2 — DROID DP Transformer on LIBERO (full vision)
# Runs a few steps to verify the pipeline works.
#
# Usage:
#   ./scripts/train/debug_dah_stage2_droid_dp_t_libero.sh <stage1_ckpt> [EXTRA_ARGS...]
#
# Example:
#   ./scripts/train/debug_dah_stage2_droid_dp_t_libero.sh data/outputs/.../checkpoints/last.ckpt
...
RUN_DIR="data/outputs/debug/debug_dah_stage2_droid_dp_t_libero"
rm -rf "${RUN_DIR}"

echo "=========================================="
echo "[DEBUG] DAH Stage 2 — DROID DP-T LIBERO"
...
python trainer.py \
    ...
    \
    run_dir="${RUN_DIR}" \
    run_name="debug_dah_stage2_droid_dp_t_libero" \
    \
