...
class AsyncVectorEnv(VectorEnv):
    ...
    def __init__(
        ...
        dummy_env.close()
        del dummy_env
        # Manually set attributes instead of calling super().__init__(),
        # which changed signature in gymnasium >= 1.0.
    ...
    def reset_wait(self, timeout=None, seed=None, options=None):
        ...
        seed : int, optional
            Seed for resetting the environment (handled in reset_async).
