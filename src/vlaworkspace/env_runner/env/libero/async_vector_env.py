...
Adapted from diffusion_policy/diffusion_policy/gym_util/async_vector_env.py
...
class AsyncVectorEnv:
    ...
    def __init__(
        ...
        # Initialize _state and closed FIRST to prevent AttributeError in __del__
        ...
        # Manually set all VectorEnv-like attributes (no inheritance)
    ...
    def reset(self, timeout=None, **kwargs):
        """Synchronous reset method with optional timeout."""
        self.reset_async()
        return self.reset_wait(timeout=timeout)

    def step(self, actions, timeout=None):
        """Synchronous step method with optional timeout."""
        self.step_async(actions)
        return self.step_wait(timeout=timeout)
