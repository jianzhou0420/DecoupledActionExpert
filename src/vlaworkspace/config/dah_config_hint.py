...
class EnvRunnerConfig:
    _target_: str = "vlaworkspace.env_runner.robomimic_runner.RobomimicRunner"
...
@dataclass
class PolicyConfig:
    _target_: str = "vlaworkspace.policy.dah_dp_c.DiffusionUnetHybridImagePolicy"
    shape_meta: ShapeDict = field(default_factory=dict)
...
@dataclass
class EMAConfig:
    _target_: str = "vlaworkspace.model.DecoupledActionHead.diffusion.ema_model.EMAModel"
...
class AppConfig(DictConfig):
    ...
    # Primary Configs
    name: str = "diff_c"
    _target_: str = "vlaworkspace.model.DecoupledActionHead.workspace.train_diffusion_unet_hybrid_workspace.TrainDiffusionUnetHybridWorkspace"
    shape_meta: ShapeDict = field(default_factory=dict)
    ...
    dataset: str = "vlaworkspace.model.DecoupledActionHead.dataset.robomimic_replay_image_dataset.RobomimicReplayImageDataset"
