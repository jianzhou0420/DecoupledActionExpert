...
from vlaworkspace.model.action_expert.film_layers import FilMSelfAttnDecoderLayer, FiLMLayer, FilMTransformerDecoder
...
class TransformerForDiffusionFiLM(ModuleAttrMixin):
    def __init__(self,
                 input_dim: int,
                 output_dim: int,
                 horizon: int,
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, TransformerForDiffusionFiLM):
