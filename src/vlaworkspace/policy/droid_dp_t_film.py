"""DROID Diffusion Policy with Transformer+FiLM action expert.
...
action expert with TransformerForDiffusion (FiLM variant).
...
- FiLM modulation in self-attention and FFN layers
"""
...
from vlaworkspace.model.DecoupledActionHead.diffusion.transformer_for_diffusion_film import TransformerForDiffusion
...
class DroidDiffusionPolicyTFiLM(BasePolicy):
    def __init__(
        self,
        shape_meta: dict,
        ...
        n_cond_layers: int = 0,
        enable_film_self_attn: bool = True,
        enable_film_ffn: bool = True,
        ...
        **kwargs,
        ...
        # Create Transformer+FiLM action expert
