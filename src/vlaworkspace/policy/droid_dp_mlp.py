"""DROID Diffusion Policy with MLP action expert.
...
action expert with MLPForDiffusion.
...
from vlaworkspace.model.DecoupledActionHead.diffusion.MLP_FiLM import MLPForDiffusion
...
class DroidDiffusionPolicyMLP(BasePolicy):
    def __init__(
        self,
        shape_meta: dict,
        ...
        **kwargs,
        ...
        model = MLPForDiffusion(
            ...
            parallel_input_emb=parallel_input_emb,
        )
